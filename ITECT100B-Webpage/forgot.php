...
<html lang="en">
<head>
    <title>MIDTERM FULL FUNCTION- Forgot Password</title> 
    ...
    <div class="wrapper">
        <div class="form">
            ...
            <div class="container">
                ...
                <button type="button" class="btn" name="register" onclick="window.location.href='../ITECT100B-Webpage/index.php'">Cancel</button>
                </center>          
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($newpassword !== $confirmpassword){
            ...
            echo "<h4>Password Changed. Go to <a href='../ITECT100B-Webpage/index.php'> Login <a></h4>";
