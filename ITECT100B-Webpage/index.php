...
<html lang="en">
<head>
    <title>MIDTERM FULL FUNCTION - Login</title> 
        ...
        <div class="form">
            ...
            <div class="container">
                <form class="form group" action="/authenticator.php">
                    ...
                    <input class="text" id="username" type="text" name="username" placeholder="Username"><br><br>
                ...
                <center><button type="submit" class="btn" method="post" name="login">Login</button>
                    <button type="button" class="btn" name="register" onclick="window.location.href='../ITECT100B-Webpage/signup.php'">Register</button>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <h1><a href="../ITECT100B-Webpage/forgot.php"> FORGOT PASSWORD </a></h1>               
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../ITECT100B-Webpage/authenticator.php");
