...
<html lang="en">
<head>
    <title>MIDTERM FULL FUNCTION - Authenticator</title>
    <meta charset="UTF-8">
    ...
    <body style="background-color:#00a31c;">    
                  ...
                  <!-- Modal content-->
                    ...
                    <center><input type="text" id="hhh" name="code" class="input" placeholder="Authentication Code" maxlength="6">
                   <br>
                </div>
        ...
        <h1 id="h"> AUTHENTICATION CODE </h1><br>
        <h4 id="code"><?php echo $_SESSION["codee"]; ?>       
        </h4><br><br><br><br>
