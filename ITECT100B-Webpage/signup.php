...
<html>
<head>
	<title>MIDTERM FULL FUNCTION- SIGN UP</title>
...
<body>
          ...
          <form method="post">
            <div class="wrapper">
                <div class="form2">
                    <h1 id="hh"> USER REGISTRATION </h1> 
                  <label>Name:</label>
                  <input type = "text" class="input" name = "name"  placeholder = "Name"> 
                  <label>Email:</label>
                  <input type = "text" class="input" name = "email"  placeholder = "E-mail Address" > 
                  <label>Username:</label>
                  <input type = "text" class="input" name = "username"  placeholder = "Username" > 
                  <label>Password</label>
                  <input type = "password" class="input" name = "password"  placeholder = "Password">
                  <label>Confirm Password</label>
                   <input type = "password" class="input" name = "confirm"  placeholder = "Confirm"> 

                  <h1><input type = "submit"  class="btn" value = "Register" >
                  <input type = "button" class="btn" value = "Cancel" onclick="window.location.href = '../ITECT100B-Webpage/index.php';"></h1>
              </div>
            </div>  
